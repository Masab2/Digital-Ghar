...
class SelectAdminImageWidgetContracter extends StatelessWidget {
  const SelectAdminImageWidgetContracter({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer<ContractorProfileViewmodel>(builder: (context, viewModel, child) {
      return InkWell(
        onTap: () {
